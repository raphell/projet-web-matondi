...
<section id="contact">
    <div class="container-fluid">
        <div class="section-content">
            ...
            <h3>Rentrez vos identifiants d'organisateur</h3>
        </div>
        <div class="container">
	        <div class="row">
        ...
        <div class="contact-section">
	        <div class="container">
			    <div class="row">
				    <form method="POST" action="gestion" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					    <div class="form-group">
					        <label for="identifiant">Login</label>
					        <input type="text" class="form-control" id="identifiant" name="identifiant" value="${identifiant}"/>
					    </div>
					    <div class="form-group">    
